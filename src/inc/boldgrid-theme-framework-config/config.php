...
if ( ! function_exists( 'boldgrid_crio_framework_config' ) ) {
	/**
	 ...
	 * @since 1.0.0
	 */
	function boldgrid_crio_framework_config( $config ) {
...
add_filter( 'boldgrid_theme_framework_config', 'boldgrid_crio_framework_config' );
