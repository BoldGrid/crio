...
( function( $ ) {
	...
	colorPalette.palette_generator = window.BOLDGRID.COLOR_PALETTE.Generate;
	...
	colorPalette.bind_generate_palette_action = function() {
		self.$palette_control_wrapper.find( '.palette-generator-button' ).on( 'click', function() {
			...
			// Generate Palettes.
			var palettes = window.BOLDGRID.COLOR_PALETTE.Generate.generate_palette_collection( paletteData, colorPalette.generated_color_palettes );
	...
	colorPalette.doCompile = function() {
		...
		if ( currentCompile && ! window.BOLDGRID.Sass.processing ) {
			window.BOLDGRID.Sass.compile( currentCompile.content, currentCompile.options );
	...
	window.BOLDGRID = window.BOLDGRID ? window.BOLDGRID : {};
	console.log( window.BOLDGRID );
	window.BOLDGRID.COLOR_PALETTE = window.BOLDGRID.COLOR_PALETTE ? window.BOLDGRID.COLOR_PALETTE : BOLDGRID.COLOR_PALETTE;
	window.BOLDGRID.COLOR_PALETTE.Modify = window.BOLDGRID.COLOR_PALETTE.Modify ? window.BOLDGRID.COLOR_PALETTE.Modify : BOLDGRID.COLOR_PALETTE.Modify;
