...
== 2.22.13 ==
* Update: Fix broken rendering on WordPress 6.9.2+

== 2.22.12 ==
* Update: Bump version to 2.22.12 -- Tested up to 6.9

== 2.22.11 ==
* Update: Updated Woocomerce Templates [#147](https://github.com/BoldGrid/crio/issues/147)
...
* Bug Fix: Welcome to Crio page has markup showing [#120](https://github.com/BoldGrid/crio/issues/120)

== 2.22.3 ==
* Update: Updated WordPress tested up to version to 6.6
